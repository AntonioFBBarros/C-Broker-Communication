...
{
    public class UserAndSensorLocationsDontMatchExceptionFilterAttribute : ExceptionFilterAttribute
    {
        public override void OnException(HttpActionExecutedContext context)
        {
            if (context.Exception is UserAndSensorLocationsDontMatchException)
            {
